...
#import "AWPTextListViewController.h"
#import "AWPTextPage.h"
#import <AFNetworking/UIImageView+AFNetworking.h>
#import "UIColor+ColorWithHex.h"

@interface AWPTextListViewController ()

@end

@implementation AWPTextListViewController
...
- (void)viewDidLoad
{
    ...
    self.titulo.textColor = [UIColor colorWithHexString: plPage.titleColor andAlpha:1 ];
    //gradiente
...
//    [imagen setImageWithURL:[NSURL URLWithString:tObj.content_img]];
    ...
    titulo.textColor = [UIColor colorWithHexString: tObj.titleColor andAlpha:1 ];
