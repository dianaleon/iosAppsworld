//
//  AWPCatalogoPageViewController.h
//  portfolio
//
...
@interface AWPCatalogoPageViewController : AWPPageViewController <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
